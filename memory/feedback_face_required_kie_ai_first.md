...
Type 8 Kanji-style) MUST be generated via kie.ai Nano Banana Pro with `image_input[0]`
...
**Correct path:**
1. kie.ai Nano Banana Pro with `image_input: [face_primary.blotato_url]` — PRIMARY for
